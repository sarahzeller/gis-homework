...
(4) (3) with heteroskedasticity-robust standard errors (White correction)
(3) FE-OLS on raster-id level and with raster-level clustered standard errors (excluding the lightning variable, since it is colinear with the raster-id)

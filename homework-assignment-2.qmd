...
data <- nightlights_sf |>
  cbind(nightlights_state |> select(state_name)) |> 
...
regression_2g <- feols(number_2g ~ DN_NTL_2021 + lightnings_tanzania + tri_tanzania + ghsl, data = data)
regression_3g <- feols(number_3g ~ DN_NTL_2021 + lightnings_tanzania + tri_tanzania + ghsl, data = data)
regression_4g <- feols(number_4g ~ DN_NTL_2021 + lightnings_tanzania + tri_tanzania + ghsl, data = data)
